							...
							<td>
								...
								<div class="pagination">
									<ul>
										...
										<li class="disablepage"><a href="${pageContext.request.contextPath }/products/query?currentPage=${pb.currentPage==1?1:pb.currentPage-1}">上一页 &lt;&lt;</li></a>
										
										<li class="">第${pb.currentPage==null?1:pb.currentPage }页/共${pb.totalPage }页</li>

										<li class="nextpage"><a href="${pageContext.request.contextPath }/products/query?currentPage=${pb.currentPage==pb.totalPage?pb.currentPage:pb.currentPage+1}">下一页&gt;&gt;</a>
										</li>
